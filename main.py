...
weapons = ["Fist", "Knife", "Club", "Gun", "Bomb", "Nuclear Bomb"] #Weapon Choices
diceOptions = [1, 2, 3, 4, 5, 6]

#Lab Week 2
input("Roll the dice for your weapon strength (Press Enter)")
weaponRoll = random.choice(diceOptions) #Rolling dice for weapon
print("You rolled " + str(weaponRoll) + " as " + weapons[weaponRoll - 1])

if int(weaponRoll) - 1 <= 2 :
    print("You rolled a weak weapon, friend")
elif 4 >= int(weaponRoll) - 1 > 2:
    print("Your weapon is meh")
else:
    print("Nice weapon, friend !")

if weapons[weaponRoll - 1] != "Fist":
    print("Thank goodness you didn't roll the First.....")
try:
...
print("Your combat strength with " + weapons[weaponRoll - 1] + " is " + str(combatStrength))
try:
